...
var PokeRows = (function (_React$Component) {
	_inherits(PokeRows, _React$Component);

	function PokeRows() {
		_classCallCheck(this, PokeRows);

		_get(Object.getPrototypeOf(PokeRows.prototype), 'constructor', this).apply(this, arguments);
	}

	_createClass(PokeRows, [{
		key: 'render',
		value: function render() {
...
var _PokeRows = require('./PokeRows');

var _PokeRows2 = _interopRequireDefault(_PokeRows);
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				this.props.pokemons.map(function (pokemon) {
					return _react2['default'].createElement(_PokeRows2['default'], { key: pokemon.number, name: pokemon.name, number: pokemon.number });
				})
			);
		}
	}]);
...
},{"./PokeRows":3,"react":160}],5:[function(require,module,exports){
